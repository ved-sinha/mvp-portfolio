      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        <div className={cn(
          ...
          <div className="relative z-10 flex items-center justify-center gap-6">
            {/* Moon Icon */}
            <div className="w-16 h-16 bg-gradient-to-br from-white/90 to-white/70 rounded-full flex items-center justify-center backdrop-blur-md border border-white/80 shadow-xl relative group">
              <div className="absolute inset-0 bg-gradient-to-br from-white/40 to-transparent rounded-full"></div>
              <svg className="w-8 h-8 text-gray-800 drop-shadow-sm relative z-10 group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-col items-center gap-3">
              <div className="flex items-center gap-4">
                <span className="text-gray-600 font-black text-2xl md:text-3xl drop-shadow-lg tracking-wide">
                  An MVP in 3 weeks for
                </span>
                
                {/* Dropdown Arrow */}
                <div className="flex flex-col gap-0.5 group">
                  <svg className="w-4 h-4 text-gray-800 drop-shadow-sm group-hover:text-gray-600 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-gray-400 font-semibold text-xl md:text-2xl line-through drop-shadow-sm opacity-75">
                  $8333
                </span>
                
                {/* Current Price */}
                <span className="text-red-600 font-black text-3xl md:text-4xl drop-shadow-lg bg-gradient-to-r from-red-600 to-red-500 bg-clip-text text-transparent">
                  $5000
                </span>
              </div>
              
              {/* Limited Time Chip */}
              <div className="mt-3 px-6 py-2.5 bg-gradient-to-r from-red-500 to-red-600 text-white text-sm font-bold rounded-full shadow-xl border border-red-400/50 hover:shadow-2xl hover:scale-105 transition-all duration-300">
                Just for this month
              </div>
            </div>
          </div>
